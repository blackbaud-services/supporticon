...
if (process.env.SUPPORTICON_API_CLIENT_SECRET) {
  defaults.headers['x-application-key'] = process.env.SUPPORTICON_API_CLIENT_SECRET;
}
...
export const imagesAPI = axios.create({
  baseURL: isStaging() ? 'https://images.staging.justgiving.com' : 'https://images.justgiving.com',
});
