  ...
  describe('uses the correct url', () => {
    it('for a charity', (done) => {
      ...
      moxios.wait(() => {
        ...
        expect(request.url).to.eql('/v1/justgiving/donations?charityId=12345');
        done();
      });
    });
    ...
    it('for a page', (done) => {
      ...
      moxios.wait(() => {
        const request = moxios.requests.mostRecent();
        expect(request.url).to.contain('/v1/justgiving/donations?fundraisingPageId=123456');
        done();
      });
    });
    ...
    it('for a campaign', (done) => {
      ...
      moxios.wait(() => {
        const request = moxios.requests.mostRecent();
        expect(request.url).to.contain('/v1/justgiving/donations?campaignGuid=1234-abcd-5678');
        done();
      });
    });
    ...
    it('for multiple campaigns', (done) => {
      ...
      moxios.wait(() => {
        const request = moxios.requests.mostRecent();
        expect(request.url).to.contain('/v1/justgiving/donations');
        expect(request.url).to.contain('campaignGuid=1234-abcd-5678,abcd-1234-9876');
        done();
      });
    });
    ...
    it('for an event', (done) => {
      ...
      moxios.wait(() => {
        const request = moxios.requests.mostRecent();
        expect(request.url).to.contain('/v1/justgiving/donations?eventId=1234');
        done();
      });
    });
