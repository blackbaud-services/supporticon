    ...
    return form.submit().then((data) => {
      ...
      return signUp(dataPayload)
        ...
        .catch((error) => {
          let errors = [];
          const message =
            get(error, "data.error.message") || get(error, "data.errorMessage");
      ...
      >
        <Grid spacing={{ x: 0.5 }} {...grid}>
          <GridColumn sm={6} {...gridColumn}>
            ...
            {externalValidationMessages &&
            externalValidationMessages.firstname ? (
              <span style={externalValidationStyles}>
                {externalValidationMessages.firstname}
              </span>
            ) : (
              <></>
          ...
          <GridColumn sm={6} {...gridColumn}>
            ...
            {externalValidationMessages &&
            externalValidationMessages.lastname ? (
              <span style={externalValidationStyles}>
                {externalValidationMessages.lastname}
              </span>
            ) : (
        ...
        {externalValidationMessages && externalValidationMessages.email ? (
          <span style={externalValidationStyles}>
            {externalValidationMessages.email}
          </span>
        ) : (
          <></>
        )}
