...
const PasswordValidations = ({ form }) => {
  const [passwordCommonWordIsValid, setPasswordCommonWordIsValid] =
    useState(false);
  const [isCommonWordCheckLoading, setIsCommonWordCheckLoading] =
    useState(false);
  ...
  const passwordValidations = [
    ...
    {
      label:
        "Must not include your name, email address or a commonly used word",
      passes:
